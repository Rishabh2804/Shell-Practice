# Write a shell script to implement First-Come-First-Serve Scheduling Algorithm
...
# Alternative :
# for ((i = 0; i < n; ++i)); do
#     read -p "Enter the arrival time for Process P$i: " arrivalTime[$i]
#     read -p "Enter the burst time for Process P$i: " burstTime[$i]
# done
